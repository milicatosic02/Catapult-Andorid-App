...
class BreedsListViewModel @Inject constructor(
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                withContext(Dispatchers.IO){
                    ...
                    Log.d("Breeds", "Fetched breeds: $breeds")
                }
    ...
    private fun observeRepoBreeds(){
        viewModelScope.launch {
            ...
            repository.getAllBreedsFlowFromDb().collect{
                newBreedsList->
                ...
                copy(
                    breedsFilter =
                        if(query.isBlank())
                            ...
                            breeds.filter { breedsInfoDetails -> breedsInfoDetails.doesMatchSearchQuery(query) } ,
